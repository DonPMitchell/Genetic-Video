...
//
extern float BandNoise(const float rgf[], int nDim);
...
extern float GradientBandNoise(float rgfGrad[], const float rgf[], int nDim);
...
extern float PeriodicTexture(const float rgf[], int nDim, float fBandlimit, ML_TextureType *pt);
